...
public class JvmMetricSetTest {
  ...
  public void testJVMMetrics() throws Exception {
    List<String> expected = Arrays.asList(
        ...
        "jvm.memory.pools.committed.bytes[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.committed.bytes[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.committed.bytes[generation:survivor,type:ps_survivor_space]",
        ...
        "jvm.memory.pools.init.bytes[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.init.bytes[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.init.bytes[generation:survivor,type:ps_survivor_space]",
        ...
        "jvm.memory.pools.max.bytes[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.max.bytes[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.max.bytes[generation:survivor,type:ps_survivor_space]",
        ...
        "jvm.memory.pools.usage[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.usage[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.usage[generation:survivor,type:ps_survivor_space]",
        ...
        "jvm.memory.pools.used.bytes[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.used.bytes[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.used.bytes[generation:survivor,type:ps_survivor_space]",
        "jvm.memory.pools.used_after_gc.bytes[generation:eden,type:ps_eden_space]",
        "jvm.memory.pools.used_after_gc.bytes[generation:old,type:ps_old_gen]",
        "jvm.memory.pools.used_after_gc.bytes[generation:survivor,type:ps_survivor_space]",
