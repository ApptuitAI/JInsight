...
public class JvmMetricSetTest {
  ...
  public void testJVMMetrics() throws Exception {
    List<String> expected = Arrays.asList(
        ...
        "jvm.memory.pools.committed.bytes[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.committed.bytes[name:ps_old_gen,type:old]",
        "jvm.memory.pools.committed.bytes[name:ps_survivor_space,type:survivor]",
        ...
        "jvm.memory.pools.init.bytes[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.init.bytes[name:ps_old_gen,type:old]",
        "jvm.memory.pools.init.bytes[name:ps_survivor_space,type:survivor]",
        ...
        "jvm.memory.pools.max.bytes[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.max.bytes[name:ps_old_gen,type:old]",
        "jvm.memory.pools.max.bytes[name:ps_survivor_space,type:survivor]",
        ...
        "jvm.memory.pools.usage[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.usage[name:ps_old_gen,type:old]",
        "jvm.memory.pools.usage[name:ps_survivor_space,type:survivor]",
        ...
        "jvm.memory.pools.used.bytes[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.used.bytes[name:ps_old_gen,type:old]",
        "jvm.memory.pools.used.bytes[name:ps_survivor_space,type:survivor]",
        "jvm.memory.pools.used_after_gc.bytes[name:ps_eden_space,type:eden]",
        "jvm.memory.pools.used_after_gc.bytes[name:ps_old_gen,type:old]",
        "jvm.memory.pools.used_after_gc.bytes[name:ps_survivor_space,type:survivor]",
